# Paso 1 - Importar bibliotecas y configurar clave
...
#Paso 2 - Función para peticiones
...
#Paso 3 - Funcionamiento básico

print("Bienvenido a la primera versión del BotJC. Escribe 'salir' para finalizar la conversación")
while True:
    ...
    for pregunta, respuesta in zip(preguntas_anteriores, respuestas_anteriores):
        ...
        conversacion_historica += f"BotJC responde: {respuesta}\n"
